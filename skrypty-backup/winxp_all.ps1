...
$VMNames = "winxp-halina","winxp-anton","winxp-kasia","WINXP-AGNIESZKA","WINXP-GOSIAM","WINXP-GRZESIEK","WINXP-KUBA","WINXP-LUKASZ","WINXP-MARTA","WINXP-MONIKA","WINXP-ZBYSZEK"
